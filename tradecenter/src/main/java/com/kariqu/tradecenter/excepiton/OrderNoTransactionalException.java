 ...
 *
 * 当前此异常是第1种 >> 简单的检查异常, 不参与事务, 但必须保证要在参与 db 操作之前校验完所有数据.
 * </pre>
 */
public class OrderNoTransactionalException extends OrderBaseException {

    public OrderNoTransactionalException() {}

    public OrderNoTransactionalException(String message) {
        super(message);
    }

    public OrderNoTransactionalException(String message, Throwable cause) {
        super(message, cause);
    }

    public OrderNoTransactionalException(Throwable cause) {
        super(cause);
    }
