...
public class Request {
     ...
     * @throws com.kariqu.common.oauth.scribe.exceptions.RuntimeException
    ...
    byte[] getByteBodyContents() {
        ...
        try {
            ...
            throw new RuntimeException("Unsupported Charset: " + getCharset(), uee);
        }
    }
    ...
    public String toString() {
        return String.format("@Request(%s %s)", getVerb(), getUrl() + querystringParams.toString() + bodyParams.toString());
    }
}
