...
/**
 * Cryptography utils (加密,解密)
 * Created by Canal.wen on 2014/6/27 14:37.
 */
public class Crypto {
    //这个先在这里写死,以后要从配制文件里读取
    public final static String secretKey = "6vyq9aq1xn0gpwqzvdjhs6u10lbb13q8u3yvby19gk0hg3csbkvag1knvk9gf65g";
    ...
    public static String sign(String message) {
        return sign(message, secretKey.getBytes());
    }
    ...
    public static String encryptAES(String value) {
        return encryptAES(value, secretKey.substring(0, 16));
    }
    ...
    public static String decryptAES(String value) {
        return decryptAES(value, secretKey.substring(0, 16));
    }
