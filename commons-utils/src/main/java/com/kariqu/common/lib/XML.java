...
/**
 * xml的常用函数
 * Created by Canal.wen on 2014/6/27 14:47.
 */
public class XML {
    static final Logger LOG = LoggerFactory.getLogger(XML.class);
    ...
    public static Document getDocument(File file) {
        ...
        try {
            ...
            LOG.warn("Parsing error when building Document object from xml file '" + file + "'.", e);
        } catch (IOException e) {
            LOG.warn("Reading error when building Document object from xml file '" + file + "'.", e);
    ...
    public static Document getDocument(String xml) {
        ...
        try {
            ...
            LOG.warn("Parsing error when building Document object from xml data.", e);
        } catch (IOException e) {
            LOG.warn("Reading error when building Document object from xml data.", e);
        } catch (ParserConfigurationException e) {
            LOG.warn("Parsing error when building Document object from xml data.", e);
        }
        return null;
    ...
    public static boolean validSignature(Document document, Key publicKey) {
        ...
        try {
            ...
            LOG.warn("Error validating an XML signature.", e);
            return false;
        }
    }
    ...
    public static Document sign(Document document, RSAPublicKey publicKey, RSAPrivateKey privateKey) {
        ...
        try {
            ...
            LOG.warn("Error while signing an XML document.", e);
        }
