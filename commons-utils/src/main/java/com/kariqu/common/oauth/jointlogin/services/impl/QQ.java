 ...
 * Time: 上午11:47
 */
class QQ extends AnalyzeUserMap implements PlatformUserInfo {

    private static Log logger = LogFactory.getLog(QQ.class);

    public static final String OPNEID_URL = "https://graph.qq.com/oauth2.0/me";
    public static final String USERINFO_URL = "https://graph.qq.com/user/get_user_info";
    ...
    public QQ( OAuthConfig authConfig) {
    ...
    /**
     * 获取用户信息 腾讯accessToken 默认有效期为3个月
     *
     * @param accessToken
     * @return
     * @throws IOException
    ...
    private Map<String, Object> getUserInfo_Map(Token accessToken) {
        ...
        //qq和其他遵循规范oauth不同，需要这两个参数，一个是appid，一个是openId
