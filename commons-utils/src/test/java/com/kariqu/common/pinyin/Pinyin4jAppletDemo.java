...
public class Pinyin4jAppletDemo extends JApplet
{
    ...
    private JPanel getUnformattedTongyongPinyinPanel()
    {
        if (unformattedTongyongPinyinPanel == null)
        {
            ...
            unformattedTongyongPinyinPanel.add(unformattedTongyongPinyinLabel, BorderLayout.NORTH); // Generated
    ...
    private JPanel getUnformattedWadePinyinPanel()
    {
        if (unformattedWadePinyinPanel == null)
        {
            ...
            unformattedWadePinyinPanel.add(unformattedWadePinyinLabel, BorderLayout.NORTH); // Generated
    ...
    private JPanel getUnformattedMPS2PinyinPanel()
    {
        if (unformattedMPS2PinyinPanel == null)
        {
            ...
            unformattedMPS2PinyinPanel.add(unformattedMPS2PinyinLabel, BorderLayout.NORTH); // Generated
    ...
    private JPanel getUnformattedYalePinyinPanel()
    {
        if (unformattedYalePinyinPanel == null)
        {
            ...
            unformattedYalePinyinPanel.add(unformattedYalePinyinLabel, BorderLayout.NORTH); // Generated
    ...
    private JPanel getUnformattedGwoyeuRomatzyhPanel()
    {
        if (unformattedGwoyeuRomatzyhPanel == null)
        {
            ...
            unformattedGwoyeuRomatzyhPanel.add(unformattedGwoyeuRomatzyhLabel, BorderLayout.NORTH); // Generated
    ...
    private JPanel getJContentPane()
    {
        if (jContentPane == null)
        {
            ...
            jContentPane.add(getOptionPanel(), BorderLayout.NORTH); // Generated
    ...
    private JPanel getFormattedCharPanel()
    {
        if (formattedCharPanel == null)
        {
            ...
            formattedCharPanel.add(getFormattedOutputField(), BorderLayout.CENTER); // Generated
        }
    ...
    private JPanel getOptionPanel()
    {
        if (optionPanel == null)
        {
            ...
            optionPanel.setPreferredSize(new Dimension(640, 34)); // Generated
