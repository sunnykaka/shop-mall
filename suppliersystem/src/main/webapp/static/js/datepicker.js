			...
			if ( jQuery(this).is('input') && 'text' == jQuery(this).attr('type')) {
				...
				_this.click(function (ev) {
					...
					if (false == jQuery.data($this.get(0), "simpleDatepicker").hasDatepicker) {
						...
						//bind dataPicker event
						var isLocked=false;
						jQuery(datepicker).hover(function(es){
							isLocked=true;
						},function(es){
							isLocked=false;
						});
						...
						jQuery("select", datepicker).bind('change', function () { loadMonth (null, $this, datepicker, chosendate); isLocked=true;});
