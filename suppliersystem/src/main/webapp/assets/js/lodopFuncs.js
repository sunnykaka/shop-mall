function getLodop(oOBJECT, oEMBED) {
    ...
    var baseUrl = '';
    var strHtmInstall = "<br><font color='#5c3b26'>打印控件未安装!点击这里<a href='" + baseUrl + "/static/install_lodop32.zip'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
    var strHtmUpdate = "<br><font color='#5c3b26'>打印控件需要升级!点击这里<a href='" + baseUrl + "/static/install_lodop32.zip'>执行升级</a>,升级后请重新进入。</font>";
    var strHtm64_Install = "<br><font color='#5c3b26'>打印控件未安装!点击这里<a href='" + baseUrl + "/static/install_lodop64.zip'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
    var strHtm64_Update = "<br><font color='#5c3b26'>打印控件需要升级!点击这里<a href='" + baseUrl + "/static/install_lodop64.zip'>执行升级</a>,升级后请重新进入。</font>";
    var strHtmFireFox = "<br><br><font color='#5c3b26'>注意：<br>1：如曾安装过Lodop旧版附件npActiveXPLugin,请在【工具】->【附加组件】->【扩展】中先卸它。";
    var LODOP = oEMBED;
    try {
